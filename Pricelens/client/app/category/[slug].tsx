...
function CategoryScreenContent() {
  const params = useLocalSearchParams<{ slug?: string; q?: string | string[] }>();
  ...
  // Single app color: use theme primary gradient for all category heroes (no per-category green/orange/etc.)
  const iconGradient = useMemo(() => theme.colors.primary.gradient, []);

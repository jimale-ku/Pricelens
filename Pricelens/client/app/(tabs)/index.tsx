...
export default function HomeScreen() {
  ...
  // Handle search submission - pass query so All Retailers page receives it and auto-triggers search
  // Use both href (for web) and params (for native - query string can be lost on React Native)
  const handleSearch = () => {

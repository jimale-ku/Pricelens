        ...
        <View style={{ padding: 20, paddingTop: 0 }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 12 }}>
            ...
            <View style={{ flex: 1, minWidth: '48%' }}>
              ...
              <TextInput
                style={{
                  backgroundColor: theme.colors.background.appHeaderSolid,
                  borderRadius: 12,
                  padding: 14,
                  color: '#FFFFFF',
                  fontSize: 16,
          ...
          <View style={{ padding: 20, paddingTop: 0 }}>
            ...
            <View style={{ marginBottom: 24 }}>
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8, marginBottom: 12 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.background.appHeaderSolid, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 12, marginBottom: 24 }}>
              <View style={{ flex: 1, backgroundColor: theme.colors.background.appHeaderSolid, borderRadius: 12, padding: 16, borderWidth: 2, borderColor: '#06B6D4' }}>
              ...
              <View style={{ flex: 1, backgroundColor: theme.colors.background.appHeaderSolid, borderRadius: 12, padding: 16, borderWidth: 2, borderColor: '#3B82F6' }}>
            ...
            <View style={{ gap: 16 }}>
              {hotelData.bookingSites.map((site) => (
                <View
                  key={site.rank}
                  style={{
                    backgroundColor: site.rank === 1 ? theme.colors.background.appHeaderSolid : theme.colors.background.primary,
                    borderRadius: 16,
                    padding: 16,

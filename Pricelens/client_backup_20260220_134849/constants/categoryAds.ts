...
export const CATEGORY_ADS: Record<string, CategoryAdContent> = {
  'all-retailers': {
    ...
    headline: 'Compare Prices Across All Retailers',
    body: 'Search once, compare prices from Amazon, Walmart, Target, Best Buy, and more. Find the best deal before you buy.',
    ctaText: 'Start Comparing',
    ctaUrl: 'https://pricelens.com',
